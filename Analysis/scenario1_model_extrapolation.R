...
load("sc1_boral_extrapolations_mean.RData")
load("sc1_brt_extrapolations_mean.RData")
load("sc1_glm_extrapolations_mean.RData")
load("sc1_hmsc_extrapolations_mean.RData")
load("sc1_mistnet_extrapolations_mean.RData")
load("sc1_sam_extrapolations_mean.RData")
load("sc1_raw_extrapolations.RData")
...
save(boral_ras, brt_ras, glm_ras, hmsc_ras, mistnet_ras, sam_ras, raw_ras,
     file = "sc1_model_extrapolations.RData")
