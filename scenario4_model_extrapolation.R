...
rawp_full_fun <- function(data){
  ...
  spp_arc <- simulation4[["info"]][[1]][["SAMs"]]
  
  raw <- raw[spp_arc, , drop = FALSE]
  rownames(raw) <- simulation4[["info"]][[1]][["names"]][1:18]
  raw[,1] <- simulation4[["info"]][[1]][["alpha"]]
...
save(raw_ext, file = "sc4_raw_extrapolations.RData")
...
save(sam_final, sam_full, sam_initial, file = "sc4_sam_extrapolations.RData")
...
save(sam_ext, file = "sc4_sam_extrapolations_mean.RData")

############################ MISTNET ###################################

load("sc4_mistnet.RData")
...
save(mistnet_final, mistnet_full, mistnet_initial, file = "sc4_mistnet_extrapolations.RData")
...
save(mistnet_ext, file = "sc4_mistnet_extrapolations_mean.RData")
...
save(glm_final, glm_full, glm_initial, file = "sc4_glm_extrapolations.RData")
...
save(glm_ext, file = "sc4_glm_extrapolations_mean.RData")
...
save(brt_final, brt_full, brt_initial, file = "sc4_brt_extrapolations.RData")
...
save(brt_ext, file = "sc4_brt_extrapolations_mean.RData")
