...
load("sc4_boral_extrapolations_mean.RData")
load("sc4_brt_extrapolations_mean.RData")
load("sc4_glm_extrapolations_mean.RData")
load("sc4_hmsc_extrapolations_mean.RData")
load("sc4_mistnet_extrapolations_mean.RData")
load("sc4_sam_extrapolations_mean.RData")
load("sc4_raw_extrapolations.RData")
...
save(boral_ras, brt_ras, glm_ras, hmsc_ras, mistnet_ras, sam_ras, raw_ras,
     file = "sc4_model_extrapolations.RData")
