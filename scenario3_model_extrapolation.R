...
load("sc3_boral_extrapolations_mean.RData")
load("sc3_brt_extrapolations_mean.RData")
load("sc3_glm_extrapolations_mean.RData")
load("sc3_hmsc_extrapolations_mean.RData")
load("sc3_mistnet_extrapolations_mean.RData")
load("sc3_sam_extrapolations_mean.RData")
load("sc3_raw_extrapolations.RData")
...
save(boral_ras, brt_ras, glm_ras, hmsc_ras, mistnet_ras, sam_ras, raw_ras,
     file = "sc3_model_extrapolations.RData")
